...
//        @State private var totalDiff: Double = 17.5
    var body: some View {
       ...
       // Print(jsonData.nbaComplexModel)
        ...
        let id = jsonData.basketballData[0].data[1].id
        Button(action: {
            print("$id:")
            print(nbaData.id)
        }) {
